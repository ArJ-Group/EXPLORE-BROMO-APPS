...
//NEW PAGES
import 'package:xplorebts/pages/categories/Inn/inn_home.dart';
...
class InnPage extends StatefulWidget {
  @override
  _InnPageState createState() => _InnPageState();
}

class _InnPageState extends State<InnPage> {
  @override
